...
find_program(ASN1C_COMPILER NAMES asn1c REQUIRED)
...
function (_private_configure_asn1_target TARGET_NAME SOURCE_FILES)
    ...
    target_link_libraries(${TARGET_NAME} PUBLIC asn1c::asn1c)
...
function (add_asn1_support TARGET_NAME ASN1_FILES)
    ...
    message("include: ${GENERATED_SOURCES_DIRECTORY_PATH})")
    target_include_directories(${TARGET_NAME} PRIVATE ${GENERATED_SOURCES_DIRECTORY_PATH}/../)
endfunction()
