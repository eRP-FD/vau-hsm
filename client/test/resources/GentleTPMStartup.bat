REM  batch file to start an already initialised TPM without regenerating all the keys.
REM
REM power up the TPM.
call inittpm.bat
...
%TPM_EXE_PATH%readpublic -ho 80000000 -ns -opu erpprimpub.name
 REM
...
%TPM_EXE_PATH%CreateEK -pwdk erpek -ecc nistp256 -cp -noflush
 ...
 REM
 REM Read name hash of primary key:
%TPM_EXE_PATH%readpublic -ho 80000001 -ns
 REM
