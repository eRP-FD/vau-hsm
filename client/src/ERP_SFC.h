...
#define ERP_SFC_WRAP_PSEUDONAME_LOG_KEY_PACKAGE 39
#define ERP_SFC_UNWRAP_PSEUDONAME_LOG_KEY_PACKAGE 40
#define ERP_SFC_WRAP_PSEUDONAME_LOG_KEY  41
#define ERP_SFC_UNWRAP_PSEUDONAME_LOG_KEY 42
