...
set(_PRIVATE_DEFAULT_HSM_ADMIN_LOGON_KEY ${CMAKE_BINARY_DIR}/simulator/keys/admin_logon.key)
set(_PRIVATE_DEFAULT_HSM_FIRMWARE_SIGN_KEY ${CMAKE_BINARY_DIR}/simulator/keys/firmware_sign.key)
...
function (_private_set_default_option_if_not_defined OPTION_VARIABLE)
    ...
    if (NOT ${EXPORTED_OPTION_VARIABLE})
        set(${EXPORTED_OPTION_VARIABLE} ${_PRIVATE_DEFAULT_${OPTION_VARIABLE}} CACHE STRING "")
    endif()
endfunction()
...
function (deployment_options_get_scripts_arguments RESULT_OUT)
    ...
    list(APPEND RESULT_LOCAL "HSM_ADMIN_TOOL=${CMAKE_BINARY_DIR}/simulator/bin/csadm")
